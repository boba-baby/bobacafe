...
setStickerRarity(1, "Diamond");
setStickerRarity(1, "Doge");
setStickerRarity(1, "Flower");
setStickerRarity(1, "Frog");
setStickerRarity(1, "Hamburger");
setStickerRarity(1, "Heart Forehead Sticker");
setStickerRarity(1, "Ice Cream Cone");
setStickerRarity(1, "Mushroom");
setStickerRarity(1, "Music Note");
setStickerRarity(50, "None");
setStickerRarity(1, "Pink Heart");
setStickerRarity(1, "Pizza");
setStickerRarity(1, "Pumpkin");
setStickerRarity(1, "Rainbow");
setStickerRarity(1, "Red Heart");
setStickerRarity(1, "Rocket");
setStickerRarity(1, "Shaka");
setStickerRarity(1, "Solana");
setStickerRarity(1, "Star Forehead Sticker");
setStickerRarity(1, "Star");
setStickerRarity(1, "Tea");
setStickerRarity(1, "Unicorn");
setStickerRarity(1, "Waves");
setStickerRarity(1, "Whale");
setStickerRarity(1, "gm");
setStickerRarity(1, "gn");
setStickerRarity(1, "ily");
