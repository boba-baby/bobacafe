...
setDrinkRarity(0.15, "Matcha Latte");
...
setDrinkRarity(0.15, "Strawberry Matcha");
...
setLidRarity(0.1, "Boba-Green");
setLidRarity(0.1, "Boba-White");
setLidRarity(0.3, "Bread Roll-Matcha");
...
setLidRarity(1, "Bull-White");
setLidRarity(1, "Bunny-Brown");
setLidRarity(1, "Bunny-Pink");
...
setEyesRarity(0, "Jack O Lantern");
